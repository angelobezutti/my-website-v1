                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Home</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Experiências</Link>
                      </li>
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Projetos</Link>
                      </li>
                    </ul>
                  </div>
                </nav>
